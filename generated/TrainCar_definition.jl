...
"""
@component function TrainCar(; name, L=0, m=nothing, g=-9.80665, theta=0)
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(TrainCar)) = print(io,
