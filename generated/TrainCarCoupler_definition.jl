...
| `f_d`         |                          | N  | 
"""
@component function TrainCarCoupler(; name, c=nothing, d=nothing)
...
export TrainCarCoupler

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(TrainCarCoupler)) = print(io,
